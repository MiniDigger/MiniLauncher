...
public class SkinCanvas extends Group {
	...
	public static final Image ALEX = new Image(SkinCanvas.class.getClassLoader().getResourceAsStream("alex.png"));
	public static final Image STEVE = new Image(SkinCanvas.class.getClassLoader().getResourceAsStream("steve.png"));
